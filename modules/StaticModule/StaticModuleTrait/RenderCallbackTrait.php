 ...
 *
 * @package CG\Divi5Modules\StaticModule
 * @since ??
 */

namespace CG\Divi5Modules\StaticModule\StaticModuleTrait;
	...
	public static function render_callback( $attrs, $content, $block, $elements ) {
		...
		$content_container = HTMLUtility::render(
			[
				'tag'               => 'div',
				'attributes'        => [
					'class' => 'cg_static_module__content-container',
				],
				'childrenSanitizer' => 'et_core_esc_previously',
				'children'          => $title . $summary . HTMLUtility::render(
					[
						'tag'               => 'div',
						'attributes'        => [
							'class' => 'cg_static_module__content',
						],
						'childrenSanitizer' => 'et_core_esc_previously',
						'children'          => $content,
					]
