...
export const StaticModuleEdit = (props: StaticModuleEditProps): ReactElement => {
  ...
  return (
    ...
    >
      ...
      <div className="cg_static_module__inner">
        <div className="cg_static_module__image">
        ...
        <div className="cg_static_module__content-container">
          {elements.render({
            attrName: 'title',
          })}
          {elements.render({
          ...
          <div className="cg_static_module__content">
            {elements.render({
              attrName: 'content',
            })}
          </div>
